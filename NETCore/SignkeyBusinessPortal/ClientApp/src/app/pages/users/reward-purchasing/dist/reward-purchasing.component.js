...
exports.RewardPurchasingComponent = void 0;
var core_1 = require("@angular/core");
var reward_1 = require("src/app/models/reward");
var reward_summary_1 = require("src/app/models/reward-summary");
var RewardPurchasingComponent = /** @class */ (function () {
    function RewardPurchasingComponent(rewardService) {
        this.rewardService = rewardService;
        this.IsLoading = false;
    }
    RewardPurchasingComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.IsLoading = true;
    ...
    RewardPurchasingComponent = __decorate([
        core_1.Component({
    ...
    return RewardPurchasingComponent;
}());
exports.RewardPurchasingComponent = RewardPurchasingComponent;
